...
const PERMISOS = {
    ...
    INVENTARIO_INICIALIZAR: [ROLES.SUPER_ADMIN, ROLES.ADMIN, ROLES.ADMINISTRATIVO], // Ingresar compras de stock

    // 📝 MÓDULO COTIZACIONES
    COTIZACIONES_LEER: [ROLES.SUPER_ADMIN, ROLES.ADMIN, ROLES.GERENTE, ROLES.ADMINISTRATIVO], // Taller no entra aquí
    ...
    OT_GESTION_MAESTRA: [ROLES.SUPER_ADMIN, ROLES.ADMIN, ROLES.GERENTE, ROLES.ADMINISTRATIVO] // Ver plata, aprobar
};
