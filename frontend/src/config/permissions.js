...
export const PERMISOS_FRONT = {
    ...
    CONFIGURACION_EMPRESA: [ROLES.SUPER_ADMIN, ROLES.ADMIN],
    ...
    INVENTARIO_SUMAR: [ROLES.SUPER_ADMIN, ROLES.ADMIN, ROLES.JEFE_TALLER, ROLES.ADMINISTRATIVO],
    ...
    OT_FINANZAS: [ROLES.SUPER_ADMIN, ROLES.ADMIN, ROLES.GERENTE, ROLES.JEFE_TALLER, ROLES.ADMINISTRATIVO]
};
