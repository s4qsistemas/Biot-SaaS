            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
                    <div
                        ...
                        className="bg-dark-surface border border-dark-border p-6 rounded-2xl shadow-sm hover:border-brand hover:bg-brand/5 cursor-pointer transition-colors"
                    >
                    ...
                    <div
                        onClick={() => navigate('/dashboard/ordenes-trabajo')}
                        className="bg-dark-surface border border-dark-border p-6 rounded-2xl shadow-sm hover:border-emerald-500 hover:bg-emerald-500/5 cursor-pointer transition-colors"
                    >
                        <div className="flex justify-between items-start mb-2">
                    ...
                    <div
                        ...
                        className="bg-dark-surface border border-dark-border p-6 rounded-2xl shadow-sm hover:border-red-500 hover:bg-red-500/5 cursor-pointer transition-colors"
                    >
                        <div className="flex justify-between items-start mb-2">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                    <button onClick={() => navigate('/dashboard/cotizaciones')} className="p-5 bg-dark-bg border border-dark-border rounded-xl text-left hover:border-brand hover:bg-dark-surface transition-all group shadow-sm">
                    ...
                    <button onClick={() => navigate('/dashboard/ordenes-trabajo')} className="p-5 bg-dark-bg border border-dark-border rounded-xl text-left hover:border-emerald-500 hover:bg-dark-surface transition-all group shadow-sm">
                    ...
                    <button onClick={() => navigate('/dashboard/inventario')} className="p-5 bg-dark-bg border border-dark-border rounded-xl text-left hover:border-blue-500 hover:bg-dark-surface transition-all group shadow-sm">
                    ...
                    <button onClick={() => navigate('/dashboard/catalogos')} className="p-5 bg-dark-bg border border-dark-border rounded-xl text-left hover:border-purple-500 hover:bg-dark-surface transition-all group shadow-sm">
                        ...
                        <p className="text-[11px] text-txt-secondary mt-1">Gestionar catálogos maestros</p>
                    </button>
                </div>
